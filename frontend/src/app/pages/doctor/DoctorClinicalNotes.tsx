...
export const DoctorClinicalNotes = () => {
  ...
  const [history, setHistory] = useState<HistoryEntry[]>(activeDoc.history);
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
      if (e.key === 'Tab' && currentSuggestion && aiTextSuggestions) {
          ...
          setHistory(prev => [{
              ...
              author: 'Dr. Smith',
              action: 'Accepted AI phrasing',
              details: 'Enhanced clinical specificity'
          }, ...prev]);
